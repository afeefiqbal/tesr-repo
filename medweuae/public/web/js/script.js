...
$(document).ready(function(){
    ...
    $('#file-input').change(function(){
        ...
        if (file){
            ...
            if (fileSizeMB > 1) {
              $('#quote_product_image_uploaded_error').html("The file size is too large. Please upload a file that is less than 2MB.");
            } else {
                ...
                $('#quote_product_image_uploaded_error').html('');
            }
        }
    });
    ...
    $(document).on('click', '.text-filter-btn', function(){
        var brand_ids = [];
