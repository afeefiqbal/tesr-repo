  ...
  <div class="container" id="myHeader">
    <nav>
      <a href="{{url('/')}}" class="logo">
        <img src="{{asset('web/images/images/Medwe logo.png')}}" alt="{{config('app.name')}}"  style="width:156px; height:80px"/>
      </a>
      ...
      <ul class="menu" id="menu">
        ...
        <li>
          <a href="{{url('about-us')}}"  class="{{ (Request::segment(1)=='about-us')?'active':'' }}">ABOUT US</a>
        </li>
        <li >
          <a href="{{url('products')}}" class="{{ (Request::segment(1)=='products')?'active':'' }}">PRODUCTS</a>
        </li>
        <li>
          <a href="{{url('blogs')}}"  class="{{ (Request::segment(1)=='blogs')?'active':'' }}">BLOGS</a>
        </li>
        <li >
          <a href="{{url('contact-us')}}" class="{{ (Request::segment(1)=='contact-us')?'active':'' }}">CONTACT US</a>
        </li>
        <li class="request-quote-item">
          <a href="{{ url('request-quote') }}" class="request-quote-link">
              <span>Requested products</span>
          </a>
        </li>
      </ul>
      <a href="{{url('request-quote')}}" class="btn desktop-request-quote">
        <span>Requested products</span>
      </a>
