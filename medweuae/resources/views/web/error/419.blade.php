@php 
$siteInformation = App\Models\Contact::first();
$extra_meta_data = App\Models\ExtraTag::first();
$services = App\Models\Service::where('status','Active')->orderBy('sort_order','ASC')->take(14)->get();
@endphp
...
@section('content')
    ...
    <style>
        * {
        ...
        .notfound .notfound-404 h1 {
            ...
            background: url({{asset('web/images/404-bg.jpg')}}) no-repeat;
    ...
    <div id="notfound">
        <div class="notfound">
            ...
            <h2>419 - Your session expired</h2>
            <p>Your session has been expired, Please reload the page to continue.</p>
