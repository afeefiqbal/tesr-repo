                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <textarea class="form-control" name="header_tag" required id="header_tag">{{ isset($tag)?$tag->header_tag:'' }}</textarea>
                            </div>
                            <div class="form-group col-md-6">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" name="body_tag" required id="body_tag">{{ isset($tag)?$tag->body_tag:'' }}</textarea>
                            </div>
                        </div>
                    </div>
