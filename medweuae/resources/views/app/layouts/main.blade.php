...
<head>
    ...
    <link rel="stylesheet" href="{{asset('app/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('app/fancy_box/source/jquery.fancybox.css?v=2.1.5') }}" media="screen" />
    <link rel="stylesheet" type="text/css" href="{{ url('app/fancy_box/source/helpers/jquery.fancybox-buttons.css?v=1.0.5') }}" />
    <link rel="stylesheet" type="text/css" href="{{ url('app/fancy_box/source/helpers/jquery.fancybox-thumbs.css?v=1.0.7') }}" />
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('app/tooltipster/css/plugins/tooltipster/sideTip/themes/tooltipster-sideTip-punk.min.css')}}" />
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="{{asset('app/dist/img/logo.png')}}" alt="{{ config('app.name') }}">
        </div>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item dropdown user-menu">
                    <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                        <picture>
                            <img src="{{asset('app/dist/img/user-default.png')}}" class="user-image img-circle elevation-2" alt="default image">
                        </picture>
                        <span class="d-none d-md-inline">{{loggedUserName()}}</span>
                    </a>
                <ul class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                    <!-- User image -->
                    <li class="user-header" style="margin-top: 10px;">
                        <picture>
                            <img src="{{asset('app/dist/img/user-default.png')}}" style="height: 90px;width: 90px;border-radius: 50%;" class="img-circle elevation-2" alt="default image">
                        </picture>
                        <p>
                            {{loggedUserName()}}
                        </p>
                    ...
                    <li class="user-footer d-flex justify-content-center">
                        <a href="{{url(sitePrefix().'logout')}}" class="btn btn-default btn-flat">Sign out</a>
                    </li>
                </ul>
                </li>
            </ul>
        ...
        <footer class="main-footer">
            <strong>© {{date('Y')}} {{ config('app.name') }} All rights reserved. Design and Developed by 
