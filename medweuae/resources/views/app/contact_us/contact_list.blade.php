                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right py-0 align-middle">
                                                <div class="btn-group btn-group-sm">
                                                    <a href="#" class="btn btn-danger mr-2 delete_entry tooltips" title="Delete Contact" data-url="contact/delete_contact" data-id="{{$contact->id}}"><i class="fas fa-trash"></i></a>

                                                    <a class="mr-2 btn btn-primary" href="{{ url(sitePrefix().'contact/view/'.$contact->id) }}"><i class="fa fa-eye fa-lg"></i></a>

                                                    <a class="btn btn-success mr-2 replay_modal" href="javascript:void(0)"  data-url="contact/replay_to_contact" data-toggle="modal" data-replay="{!! $contact->replay !!}" data-id="{{ $contact->id }}" data-request="{!! $contact->comments !!}"><i class="fa fa-reply fa-lg" style="color:{{ ($contact->replay==NULL)?'red':'green' }}"></i></a>
                                                </div>
                                            </td>
                                        </tr>
