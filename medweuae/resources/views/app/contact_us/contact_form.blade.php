                    ...
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="alternate_phone_number" id="alternate_phone_number" class="form-control" placeholder="Alternate Phone Number" value="{{ !empty($contact)?$contact->alternate_phone_number:'' }}" maxlength="15">
                                <div class="help-block with-errors" id="alternate_phone_number_error"></div>
                            </div>
                            <div class="form-group col-md-4">
                                <label> Whatsapp Number*</label>
                                <input type="text" name="whatsapp_number" id="whatsapp_number" class="form-control required" placeholder="Whatsapp Number" value="{{ !empty($contact)?$contact->whatsapp_number:'' }}" maxlength="15">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="google_map" id="google_map" class="form-control" placeholder="Google Map">{{ !empty($contact)?$contact->google_map:'' }}</textarea>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                <label> Address</label>
                                <textarea name="address" id="address" class="form-control tinyeditor" placeholder="Address">{{ !empty($contact)?$contact->address:'' }}</textarea>
                            </div>
                        </div>
                    </div>
