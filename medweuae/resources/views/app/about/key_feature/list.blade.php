                ...
                <div class="col-12">
                    ...
                    <div class="card card-success card-outline">
                        <div class="card-header">
                            <a href="{{url(sitePrefix().'about-us/key-feature/create')}}" class="btn btn-success pull-right">Add Key Feature <i class="fa fa-plus-circle pull-right mt-1 ml-2"></i></a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right py-0 align-middle">
                                            <div class="btn-group btn-group-sm">
                                                <a href="{{url(sitePrefix().'about-us/key-feature/edit/'.$slider->id)}}" class="btn btn-success mr-2 tooltips" title="Edit Key Features"><i class="fas fa-edit"></i></a>
                                                <a href="#" class="btn btn-danger mr-2 delete_entry tooltips" title="Delete Key Feature" data-url="about-us/key-feature/delete" data-id="{{$slider->id}}"><i class="fas fa-trash"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
