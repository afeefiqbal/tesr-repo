...
<li class="nav-item {{ (Request::segment(2)=='home')?'menu-is-opening menu-open':'' }}">
  ...
  <ul class="nav nav-treeview" style="display: {{ (Request::segment(2)=='home')?'block':'none' }}">
    ...
    <li class="nav-item">
      <a href="{{url(sitePrefix().'home/brand')}}" class="nav-link {{ (Request::segment(3)=='brand' && Request::segment(2)=='home')?'active':'' }}">
        <i class="far fa-circle nav-icon"></i>
        <p>Brands</p>
      </a>
    </li>
...
<li class="nav-item {{ (Request::segment(2)=='about-us')?'menu-is-opening menu-open':'' }}">
  ...
  <ul class="nav nav-treeview" style="display: {{ (Request::segment(2)=='about-us')?'block':'none' }}">
    ...
    <li class="nav-item">
      <a href="{{url(sitePrefix().'about-us/key-feature')}}" class="nav-link {{ (Request::segment(3)=='key-feature')?'active':'' }}">
        <i class="far fa-circle nav-icon"></i>
        <p>Key-features </p>
      </a>
    </li> 
...
<li class="nav-item {{ (Request::segment(3)=='product'||Request::segment(2)=='product')?'menu-is-opening menu-open':'' }}">
  <a href="#" class="nav-link">
  ...
  <ul class="nav nav-treeview" style="display: {{ (Request::segment(3)=='item'||Request::segment(2)=='product')?'block':'none' }}">
    <li class="nav-item">
      <a href="{{url(sitePrefix().'product/category')}}" class="nav-link {{ (Request::segment(2)=='product' && (Request::segment(3)=='category' || Request::segment(3)=='sub-category'))?'active':'' }}">
        <i class="far fa-circle nav-icon"></i>
        <p>Category</p>
      </a>
    </li>
    <li class="nav-item">
      <a href="{{url(sitePrefix().'product/brand')}}" class="nav-link {{ (Request::segment(3)=='brand' && Request::segment(2)=='product')?'active':'' }}">
        <i class="far fa-circle nav-icon"></i>
        <p>Brands</p>
      </a>
    </li>
    <li class="nav-item">
      <a href="{{url(sitePrefix().'product/item')}}" class="nav-link {{ (Request::segment(2)=='product' && Request::segment(3)=='item')?'active':'' }}">
        <i class="far fa-circle nav-icon"></i>
        <p>Product </p>
      </a>
    </li>  
...
<li class="nav-item {{ (Request::segment(2)=='banner')?'menu-is-opening menu-open':'' }}">
  ...
  <ul class="nav nav-treeview" style="display: {{ (Request::segment(2)=='banner')?'block':'none' }}">
    ...
    <li class="nav-item">
      <a href="{{url(sitePrefix().'banner/product')}}" class="nav-link {{ (Request::segment(3)=='product')?'active':'' }}">
        <i class="far fa-circle nav-icon"></i>
        <p>Product </p>
      </a>
    </li> 
...
<li class="nav-item {{ (Request::segment(2)=='heding-section')?'menu-is-opening menu-open':'' }}">
  <a href="#" class="nav-link">
    <i class="nav-icon fas icon fas fa-info"></i>
    <p>
      Heading Sections
  ...
  <ul class="nav nav-treeview" style="display: {{ (Request::segment(2)=='heading-section')?'block':'none' }}">
    <li class="nav-item">
      <a href="{{url(sitePrefix().'heading-section/fproduct')}}" class="nav-link {{ (Request::segment(3)=='fproduct')?'active':'' }}">
        <i class="far fa-circle nav-icon"></i>
        <p>Featured Products </p>
      </a>
    </li> 
    <li class="nav-item">
      <a href="{{url(sitePrefix().'heading-section/blog')}}" class="nav-link {{ (Request::segment(3)=='blog')?'active':'' }}">
        <i class="far fa-circle nav-icon"></i>
        <p>Blog </p>
      </a>
    </li> 
    <li class="nav-item">
      <a href="{{url(sitePrefix().'heading-section/whychooseus')}}" class="nav-link {{ (Request::segment(3)=='whychooseus')?'active':'' }}">
        <i class="far fa-circle nav-icon"></i>
        <p>Why Choose us </p>
      </a>
    </li> 
...
<li class="nav-item {{ (Request::segment(2)=='tag')?'menu-is-opening menu-open':'' }}">
  ...
  <ul class="nav nav-treeview" style="display: {{ (Request::segment(2)=='tag'|| Request::segment(2)=='other-meta-tag')?'block':'none' }}">
    ...
    <li class="nav-item">
      <a href="{{url(sitePrefix().'tag/product')}}" class="nav-link {{ (Request::segment(3)=='product')?'active':'' }}">
        <i class="far fa-circle nav-icon"></i>
        <p>Product </p>
      </a>
    </li> 
