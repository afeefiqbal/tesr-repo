                ...
                <tr align="center" valign="top">
                    <td valign="middle" colspan="5">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-left:41px;">
                            ...
                            {{-- <tr>
                                <td style="padding:5px;font-weight:bold;">Product Image</td>
                                <td style="padding:5px;font-weight:bold;">:</td>
                                <td style="padding:5px;font-weight:bold;"><img src="{{$productImage}}" width="200"></td>
                            </tr> --}}
                            <tr>
                                <td style="padding:5px;font-weight:bold;">Message</td>
                                <td style="padding:5px;font-weight:bold;">:</td>
                                <td style="padding:5px;font-weight:bold;">{{$content}}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
