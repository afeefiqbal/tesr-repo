...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <style type="text/css">
            ...
            p,td,li,a{
                font:normal 14px Arial, Helvetica, sans-serif;line-height:22px;
                color:#242323;
                margin: 4px 0;
    ...
    <body style="background-color:#fff;font-family:Arial, Helvetica, sans-serif;">
        <table class="container" width="680" border="0" cellspacing="0" cellpadding="0" align="center" style="border-left:solid 1px #d9dadb;border-right:solid 1px #d9dadb;border-top:solid 1px #d9dadb;border-bottom:solid 1px #d9dadb; ">
            <tr>
                ...
                <td style="border-style: solid; border-color: #00afef; border-width: 2px; width:640px;">
                    <table class="container" width="640" border="0" cellspacing="0" cellpadding="0" align="center" >
                        ...
                        <tr align="left" valign="top">
                            <td  valign="middle" colspan="5">
                                <br/><br/>
                                <p style="font-size:14px;line-height:22px;padding-top:15px;">Thanks & Regards<br/>Team {{$site_name}}</p>
                                <br/><br/>
                            </td>
                        </tr>
                        <br/>
