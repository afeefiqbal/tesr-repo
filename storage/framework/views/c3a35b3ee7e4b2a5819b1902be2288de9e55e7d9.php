                ...
                <tr align="left" valign="top">
                    <td valign="middle" colspan="5">
                        <p style="font-size:14px;line-height:22px;padding-top:15px;">Dear Admin, <br/>
                            You have a new quote enquiry<br/><br/></p>
                    </td>
                </tr>
                <tr align="left" valign="top">
                    <td valign="middle" colspan="5">
                        <h2 style="font-size:14px;line-height:22px;padding-top:5px;text-transform:uppercase;"><u>Enquiry Details</u></h2><br/>
                    </td>
                </tr>
                    ...
                    <td valign="middle" colspan="5">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-left:41px;">
                            <tr>
                                ...
                                <td style="padding:5px;font-weight:bold;"><?php echo e($name); ?></td>
                            </tr>
                            <tr>
                                <td style="padding:5px;font-weight:bold;">Email</td>
                                <td style="padding:5px;font-weight:bold;">:</td>
                                <td style="padding:5px;font-weight:bold;"><?php echo e($email_id); ?></td>
                            </tr>
                            <tr>
                                <td style="padding:5px;font-weight:bold;">Phone</td>
                                <td style="padding:5px;font-weight:bold;">:</td>
                                <td style="padding:5px;font-weight:bold;"><?php echo e($phone); ?></td>
                            </tr>
                            
                            <tr>
                                <td style="padding:5px;font-weight:bold;">Message</td>
                                <td style="padding:5px;font-weight:bold;">:</td>
                                <td style="padding:5px;font-weight:bold;"><?php echo e($content); ?></td>
                            </tr>
                        </table>
                    </td>
                </tr>
...
<?php /**PATH C:\Users\Pentacodes.Marketing\Desktop\LaravelProjects\2025\Medwe\resources\views/mail_template/quote_enquiry.blade.php ENDPATH**/ ?>