...
<div class="col-xs-12 col-sm-12 col-md-6 col-lg-<?php echo e($column); ?> mw_col_wrapper">
    <div class="mw_col_inner_wrapper">
        <!--<div class="mw_price_tag">-->
        <!--    <h5>Price: <span>AED <?php echo e($product->price); ?></span></h5>-->
        <!--</div>-->
        <?php if($product->thumbnail_image!=NULL): ?>
            <img src="<?php echo e(asset($product->thumbnail_image)); ?>" class="mw_product_img">
        <?php else: ?>
            <img src="<?php echo e(asset('web/images/product_img_01.png')); ?>" class="mw_product_img">
        <?php endif; ?>     
       <div class="card">
            <h4><?php echo e($product->title); ?></h4>
        <!--<p><?php echo $product->home_description; ?></p>-->
            ...
            <a href="https://google.com">
                ...
                ?>
                 <style>
                    ...
                    <a href="https://api.whatsapp.com/send/?phone=<?php echo e($siteInformation->whatsapp_number); ?>&text=<?php echo e(urlencode($message)); ?>&type=phone_number&app_absent=0"
    ...
    <a href="<?php echo e(url('product/'.$product->short_url)); ?>">Details</a>
</button>
           
        </div>
       </div>
    </div>
</div><?php /**PATH /home/u864165095/domains/medweuae.com/public_html/resources/views/web/render/_single_product.blade.php ENDPATH**/ ?>