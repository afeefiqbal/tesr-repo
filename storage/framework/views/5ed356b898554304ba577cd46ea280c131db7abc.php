                  				...
                  				<thead>
				                   ...
				                   <?php $i=1 ?> <?php $__currentLoopData = $adminList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				                        <tr>
				                            ...
				                            <td><input id="switch-state" type="checkbox" class="status_check" data-size="mini" title="Admin" ref="<?php echo e($user->id); ?>" <?php if($user->status=="Active"){ ?>checked="checked"<?php }?>></td>
...
<?php echo $__env->make('app.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u864165095/domains/medweuae.com/public_html/resources/views/app/admin/admin_list.blade.php ENDPATH**/ ?>