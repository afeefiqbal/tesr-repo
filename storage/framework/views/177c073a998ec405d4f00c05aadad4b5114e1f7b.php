                                ...
                                <tbody>
                                   <?php $i=1 ?> <?php $__currentLoopData = $contactList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contact): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo e(asset($contact->product_image)); ?>" class="fancy"><img src="<?php echo e(asset($contact->product_image)); ?>"  style="width:50%;"></a></td>
                                            <td><?php echo e($contact->message); ?></td>
                                            <td><?php echo e(date("d-M-Y", strtotime($contact->created_at))); ?></td>
                                            <td class="text-right py-0 align-middle">
                                                <div class="btn-group btn-group-sm">
                                                    <a href="#" class="btn btn-danger mr-2 delete_entry tooltips" title="Delete Quote" data-url="contact/delete_quote" data-id="<?php echo e($contact->id); ?>"><i class="fas fa-trash"></i></a>
                                                    <a class="btn btn-success mr-2 replay_modal" href="javascript:void(0)"  data-url="contact/replay_to_quote" data-toggle="modal" data-replay="<?php echo $contact->reply; ?>" data-id="<?php echo e($contact->id); ?>" data-request="<?php echo $contact->message; ?>"><i class="fa fa-reply fa-lg" style="color:<?php echo e(($contact->reply==NULL)?'red':'green'); ?>"></i></a>
                                                </div>
                                            </td>
                                        </tr>
...
<?php echo $__env->make('app.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Pentacodes.Marketing\Desktop\LaravelProjects\2025\Medwe\resources\views/app/contact_us/quote_list.blade.php ENDPATH**/ ?>