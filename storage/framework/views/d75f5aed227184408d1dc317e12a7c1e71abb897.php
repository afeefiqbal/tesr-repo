            ...
            <form role="form" id="formWizard" class="form--wizard" enctype="multipart/form-data" method="post">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title"><?php echo e($key); ?> Banner - <?php echo e($type); ?></h3>
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control required" name="title" placeholder="Banner Title" id="title" value="<?php echo e(isset($banner)?$banner->title:''); ?>" maxlength="255">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" name="banner_meta_tag" id="banner_meta_tag" placeholder="alt='alt Image'" class="form-control required placeholder-cls" required autocomplete="off" value="<?php echo e(isset($banner)?$banner->banner_meta_tag:''); ?>">
...
$(document).ready(function(){
    $("#banner").fileinput({
        ...
        <?php if(isset($banner) && $banner->banner!=NULL){?>
            initialPreview: ["<?php echo e(asset($banner->banner)); ?>"],
            initialPreviewConfig: [{
                caption: "<?php echo e(($banner->banner!=NULL)?$banner->title:''); ?>",
                width: "120px",
                key: "<?php echo e(($banner->banner)); ?>",
            }]
        <?php }?>
    });
});
...
<?php echo $__env->make('app.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/afeef/works/website-works/medweuae/resources/views/app/banner/banner_form.blade.php ENDPATH**/ ?>